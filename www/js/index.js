function fetch_and_display_posts()
{
    ...
    xhr.open("GET", "http://www.hexthorpesocialenterprise.co.uk/wp-admin/admin-ajax.php?action=posts");
    xhr.onload = function(){
...
function login()
{
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "http://www.hexthorpesocialenterprise.co.uk/wp-admin/admin-ajax.php?action=login&username=" + encodeURIComponent(username) + "&password=" + encodeURIComponent(password));
    xhr.onload = function(){
